...
public class PageNormalizerActionX extends PageActionX  {
	...
	private final static Logger LOG = Logger.getLogger(PageNormalizerActionX.class);
	...
	public PageNormalizerActionX(AbstractActionX actionElement) {
		super(actionElement);
	}
...
//		text.setFontSize(20.0);
	...
	private void removeCSSStyleAndExpandAsSeparateAttributes() {
		...
		for (SVGElement element : elements) {
			PageNormalizerActionX.removeCSSStyleAndExpandAsSeparateAttributes(element);
		}
