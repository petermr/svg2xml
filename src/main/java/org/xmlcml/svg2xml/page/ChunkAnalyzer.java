...
//	private static void tidyStyles(Element element) {
//		if (element != null) {
...
//	private static void mergeSpans(Element element) {
//		while (true) {
...
//	}
	 ...
	 */
	public static ChunkAnalyzer createSpecificAnalyzer(SVGElement svgElement, PageAnalyzer pageAnalyzer) {
	...
	private static ChunkAnalyzer createImageAnalyzer(List<SVGImage> imageList, PageAnalyzer pageAnalyzer) {
	...
	private static ChunkAnalyzer createPathAnalyzer(List<SVGPath> pathList, PageAnalyzer pageAnalyzer) {
		ChunkAnalyzer analyzer;
...
//		throw new RuntimeException("ChunkAnalyzer.createHtmlElement()");
