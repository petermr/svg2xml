 ...
 *
 */
public abstract class AbstractTableChunk {

	private final static Logger LOG = Logger.getLogger(AbstractTableChunk.class);
	...
	protected AbstractTableChunk() {
		elementList = new ArrayList<SVGElement>();
	}
	
	public AbstractTableChunk(RealRangeArray horizontalMask, RealRangeArray verticallMask) {
		this.horizontalMask = horizontalMask;
		this.verticalMask = verticallMask;
	}

	public AbstractTableChunk(List<? extends SVGElement> elementList) {
	...
	//		System.out.println("HGHGHGHGHG"+horizontalMask);
