...
public abstract class AbstractContainerOLD {

	public final static Logger LOG = Logger.getLogger(AbstractContainerOLD.class);
	...
	protected List<AbstractContainerOLD> containerList;
	...
	public AbstractContainerOLD(PageAnalyzer pageAnalyzer) {
		this.pageAnalyzer = pageAnalyzer;
		ensureContainerList();
	}

	public AbstractContainerOLD(ChunkAnalyzer chunkAnalyzer) {
	...
	private void ensureContainerList() {
		if (containerList == null) {
			containerList = new ArrayList<AbstractContainerOLD>();
		}
	}
	
	public void add(AbstractContainerOLD abstractContainer) {
		ensureContainerList();
		containerList.add(abstractContainer);
	}
	
	public List<AbstractContainerOLD> getContainerList() {
	...
	protected String outputList(String title, List<? extends AbstractContainerOLD> containerList) {
	...
	private void calculateType() {
		...
		if (type == null) {
			if (this instanceof ScriptContainerOLD) {
				ScriptContainerOLD scriptContainer = (ScriptContainerOLD) this;
