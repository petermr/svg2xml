...
//	private final static Logger LOG = Logger.getLogger(Equivalence.class);
...
//				LOG.debug("NEW "+glyph.glyphElement.toXML());
//			} else {
//				LOG.debug("FOUND: "+/*sig+*/" "+glyph.getCharacter());
//			}
//		}
//	}
}
