 ...
 *
 */
public class HtmlAnalyzerOld /*extends PageChunkAnalyzer */ {

	static final Logger LOG = Logger.getLogger(HtmlAnalyzerOld.class);
	 ...
	 */
	public HtmlAnalyzerOld(HtmlEditor htmlEditor, PageChunkAnalyzer analyzer) {
		this(htmlEditor);
		this.analyzer = analyzer;
	}

	public HtmlAnalyzerOld(HtmlEditor htmlEditor) {
		this.htmlEditor = htmlEditor;
	}

	public HtmlAnalyzerOld(HtmlElement htmlElement, HtmlEditor htmlEditor) {
		this(htmlEditor);
	...
	void addLinks(HtmlAnalyzerOld lastAnalyzer) {
	...
	void addImageDivTo(HtmlAnalyzerOld previousAnalyzer) {
...
//	}
	...
	HtmlAnalyzerOld getPreviousHtmlAnalyzer(Map<ChunkId, HtmlAnalyzerOld>htmlAnalyzerByIdMap) {
		String previous = this.getAttributeValue(LAST);
		HtmlAnalyzerOld previousAnalyzer = (previous == null) ? null : htmlAnalyzerByIdMap.get(new ChunkId(previous));
	...
	public boolean mergeLinesWithPrevious(HtmlAnalyzerOld lastAnalyzer, HtmlElement topDiv) {
