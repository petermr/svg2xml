 ...
 * 
 * Basically a data transfer object, which is built during interpretation.
 * 
 * @author pm286
 */
public class SVGPrimitivesOLD {
	...
	public SVGPrimitivesOLD() {
		...
		imageList = new ArrayList<SVGImage>();
	}
	
	public SVGPrimitivesOLD(SVGPrimitivesOLD other) {
		...
		imageList = new ArrayList<SVGImage>(other.getImageList());
	}
	...
	public void addImages(List<SVGImage> imageList) {
