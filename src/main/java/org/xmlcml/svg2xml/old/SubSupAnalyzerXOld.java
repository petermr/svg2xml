...
public class SubSupAnalyzerXOld /*extends PageChunkAnalyzer */ {
	...
	private final static Logger LOG = Logger.getLogger(SubSupAnalyzerXOld.class);
	...
	public SubSupAnalyzerXOld(PageChunkAnalyzer textAnalyzerX) {
