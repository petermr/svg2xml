...
public class StyleSpanOLD {

	private final static Logger LOG = Logger.getLogger(StyleSpanOLD.class);
	...
	public StyleSpanOLD(boolean bold, boolean italic) {
		this.bold = bold;
		this.italic = italic;
	}
	...
	public HtmlElement createHtmlElement() {
		...
		String suscript = (character == null) ? null : SVGUtil.getSVGXAttribute(character, ScriptLineOLD.SUSCRIPT); 
		boolean sub = ScriptLineOLD.SUB.equals(suscript);
		boolean sup = ScriptLineOLD.SUP.equals(suscript);
		if (sub) {
	...
	public static StyleSpanOLD createSpace(Double fontSize) {
		StyleSpanOLD styleSpan = new StyleSpanOLD();
	...
	public String getTextContentWithSpaces() {
		...
		for (SVGText text : characterList) {
			...
			String sp = StyleSpanOLD.computeInterveningSpaces(lastText, text);
