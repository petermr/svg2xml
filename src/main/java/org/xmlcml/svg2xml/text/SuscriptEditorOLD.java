...
public class SuscriptEditorOLD {

	private static final Logger LOG = Logger.getLogger(SuscriptEditorOLD.class);
	static {
...
private boolean hasSuscripts;
	...
	public SuscriptEditorOLD(TextChunk phraseListList) {
