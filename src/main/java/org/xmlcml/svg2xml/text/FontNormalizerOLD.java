...
public class FontNormalizerOLD {
	private static final Logger LOG = Logger.getLogger(FontNormalizerOLD.class);
	static {
		LOG.setLevel(Level.DEBUG);
	}

	public final static FontNormalizerOLD DEFAULT_NORMALIZER;
	private static final int DEFAULT_THRESHOLD = 240;
	static {
		DEFAULT_NORMALIZER = new FontNormalizerOLD();
		DEFAULT_NORMALIZER.setBoldThreshold(DEFAULT_THRESHOLD);
	};
	
	private int boldThreshold = DEFAULT_THRESHOLD;

	public FontNormalizerOLD() {
	...
	public static FontNormalizerOLD getDefaultNormalizer() {
		return FontNormalizerOLD.DEFAULT_NORMALIZER;
	}
