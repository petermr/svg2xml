...
public class TextCoordinateOLD {
	...
	public TextCoordinateOLD(Double size, int decimalPlaces) {
		this.doubleCoordinate = Util.format(size, decimalPlaces);
		this.decimalPlaces = decimalPlaces;
		this.eps =  calculateEpsilon(decimalPlaces);
	}
	
	public TextCoordinateOLD(Double doubleCoordinate) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof TextCoordinateOLD) {
			TextCoordinateOLD fs = (TextCoordinateOLD)obj;
