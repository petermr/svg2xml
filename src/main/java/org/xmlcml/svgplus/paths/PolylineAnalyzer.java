...
public class PolylineAnalyzer extends AbstractPageAnalyzer {
	...
	public PolylineAnalyzer(SemanticDocumentAction semanticDocumentAction) {
...
//	}
	...
	private void addPoints(SVGPolyline polyline) {
		List<SVGMarker> pointList = polyline.createPointList();
	...
	public void analyzePolylines(SVGG svgg, List<SVGPolyline> polylines) {
		this.svgg = svgg;
		ChunkAnalyzer chunkAnalyzer = this.pageEditor.getCurrentChunkAnalyzer();
...
//				System.out.println("NULL MARKER");
	...
	public static void getMatchedPoint(SVGPolyline polyline, List<SVGPolyline> polylineList, Real2 end) {
		String col = "red";
...
//		ParentNode parent = polyline.getParent();
	...
	public static void matchEnd(SVGPolyline polyline, int line, int end, List<SVGPolyline> polylineList) {
		List<SVGLine> lineList = polyline.createLineList();
