...
public abstract class AbstractActionX extends Element {
	...
	protected AbstractActionX actionElement;
...
//			newElement = new FigureAnalyzerActionX();
	...
	public AbstractActionX(AbstractActionX actionElement) {
		super(actionElement);
		this.setActionX(actionElement);
	}
	...
	protected String getAndExpand(String attName) {
		String value = getActionX().getAttributeValue(attName);
	...
	public void setActionX(AbstractActionX actionElement) {
	...
	public String getMessage() {
		// don't expand this
		return getActionX().getAttributeValue(AbstractActionX.MESSAGE);
	}

	public String getRegex() {
		// don't expand this
		return getActionX().getAttributeValue(AbstractActionX.REGEX);
	}
	...
	public String getTitle() {
		// don't expand this
		return getActionX().getAttributeValue(AbstractActionX.TITLE);
	}
	 ...
	 * @return
	 */
	public AbstractActionX getActionX() {
